...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadingProgressBar = (ProgressBar) findViewById(R.id.pg_loading);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            MainActivity.this.mLoadingProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            MainActivity.this.mLoadingProgressBar.setVisibility(View.INVISIBLE);

            if (weatherData != null) {
                // DONE (11) If the weather data was not null, make sure the data view is visible
                MainActivity.this.showWeatherDataView();
